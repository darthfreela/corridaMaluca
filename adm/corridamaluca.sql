...
CREATE TABLE `clientes_perguntas` (
...
CREATE TABLE `clientes_perguntasvariaveis` (
...
CREATE TABLE `posvenda_perguntasfixas` (
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Tabela de perguntas fixas do sistema';


INSERT INTO `posvenda_perguntasfixas` (`perguntasfixas_id`, `nome`, `pergunta`) VALUES
(1, 'a', 'bbb'),
(2, 'b', 'ccc'),
(3, 'c', 'ddd'),
(4, 'd', 'eee'),
...
CREATE TABLE `posvenda_perguntasvariaveis` (
  ...
  `pergunta` varchar(100) NOT NULL COMMENT 'pergunta'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='tabela de perguntas variaveis gerenciadas pelo gerente';


INSERT INTO `posvenda_perguntasvariaveis` (`perguntasvariaveis_id`, `nome`, `pergunta`) VALUES
(1, 'a1', 'bbb1'),
(2, 'b1', 'ccc1'),
(3, 'c1', 'ddd1'),
(4, 'd1', 'eee1'),
...
CREATE TABLE `principal_oportunidades` (
...
CREATE TABLE `principal_oportunidades_requisitos` (
...
CREATE TABLE `principal_requisitos` (
  `requisitos_id` int(11) NOT NULL,
  `nome` varchar(80) NOT NULL,
...
ALTER TABLE `cidades`
  ...
  ADD KEY `FK_Cidades_estados` (`idEstado`);
...
ALTER TABLE `posvenda_perguntasfixas`
  MODIFY `perguntasfixas_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Campo de id das perguntas fixas', AUTO_INCREMENT=9;

ALTER TABLE `posvenda_perguntasvariaveis`
  MODIFY `perguntasvariaveis_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id das perguntas variaveis', AUTO_INCREMENT=9;

ALTER TABLE `principal_clientes`
  MODIFY `clientes_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id do cliente', AUTO_INCREMENT=2;
